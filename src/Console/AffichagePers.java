...
public class AffichagePers {
    // Méthode pour afficher la liste du personnel actif
    protected void AffichageListe(ArrayList<Personnel> Person) {
        if (Person.isEmpty()) {
            ...
            // Parcourir et afficher chaque personnel actif
    ...
    // Méthode pour afficher les détails d'une personne spécifique
