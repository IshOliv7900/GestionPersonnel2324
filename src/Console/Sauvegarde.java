...
public class Sauvegarde {
    // Méthode pour sauvegarder les données du personnel et des emprunts dans un fichier
    protected void Sauvegarde(ArrayList<Personnel> Person, ArrayList<Emprunt> pret) {
        ...
        try {
            ...
            try {
                ...
                // Parcourir et écrire chaque personnel
                while(var9.hasNext()) {
                ...
                // Parcourir et écrire chaque emprunt
                while(true) {
                    if (!var11.hasNext()) {
